...
class ImportService:
    def __init__(self, db):
        ...
        self.contact_email_db_index: Dict[str, str] = {}
        self.org_db_index: Dict[str, str] = {}
        self.stats = {
            "prospects": 0,
            "contacts": 0,
            "deals": 0,
    ...
    async def _create_activities_from_row(self, row: Dict, deal_ids: List[str],
    ...
    async def import_from_files(self, file_contents: Dict[str, str], force: bool = False) -> Dict:
        ...
        """
        # Cargar índices existentes desde DB para upsert correcto
        ...
        for idx, row in enumerate(all_rows):
            ...
            stage = _stage(estado)
            deal_ids = await self._create_deals(
                prospect_id=prospect_id,
            ...
            # Crear actividades para todos los deals
            await self._create_activities_from_row(row, deal_ids, prospect_id, responsable_id)
